      ...
      {goal.framework === "SMART" && goal.smart && (
        <div className="space-y-2 text-xs bg-sidebar/50 p-3.5 rounded-lg border border-sidebar-border">
          ...
          <ul className="space-y-1 text-muted-foreground pl-2 border-l-2 border-amber-500/40">
            <li>
              <strong className="text-foreground">Specific:</strong>{" "}
              {goal.smart.specific}
            </li>
            <li>
              <strong className="text-foreground">Measurable:</strong>{" "}
              {goal.smart.measurable}
            </li>
            <li>
              <strong className="text-foreground">Attainable:</strong>{" "}
              {goal.smart.attainable}
            </li>
            <li>
              <strong className="text-foreground">Relevant:</strong>{" "}
              {goal.smart.relevant}
            </li>
            <li>
              <strong className="text-foreground">Time-bound:</strong>{" "}
      ...
      <div>
        ...
        <div className="space-y-2">
          {goal.proposedCards.map((proposed, idx) => (
            <div
              key={
                proposed.cardDraft.id ??
                `${proposed.cardDraft.title ?? "draft"}:${proposed.suggestedAssignee}`
              }
            ...
            >
              <div className="flex items-center gap-2.5">
                ...
                <span className="font-medium text-foreground">
                  {proposed.cardDraft.title || "Untitled Card"}
                </span>
              </div>
              <div className="flex items-center gap-2 text-2xs">
